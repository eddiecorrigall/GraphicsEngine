...
class Video : public System {
	...
	public:
		...
		bool ToggleDebuggingLighting() { debug_lighting = !debug_lighting; }
		bool ToggleDebuggingNormals() { debug_normals = !debug_normals; }
		bool ToggleDebuggingView() { debug_view = !debug_view; }
		
		bool IsDebuggingVectors() {
